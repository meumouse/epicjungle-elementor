...
class Categories extends Base_Widget {
	...
	public function get_name() {
		return 'ej-wc-categories';
	}

	public function get_title() {
		return __( 'Categorias de produtos', 'epicjungle-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'number',
			[
				'label' => __( 'Contagem de categorias', 'epicjungle-elementor' ),
				'type' => Controls_Manager::NUMBER,
				'default' => '4',
			]
		);
		...
		$this->add_control(
			'source',
			[
				'label' => __( 'Fonte', 'epicjungle-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Mostrar tudo', 'epicjungle-elementor' ),
					'by_id' => __( 'Seleção manual', 'epicjungle-elementor' ),
					'by_parent' => __( 'Por pai', 'epicjungle-elementor' ),
					'current_subcategories' => __( 'Subcategorias atuais', 'epicjungle-elementor' ),
				],
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'categories',
			[
				'label' => __( 'Categorias', 'epicjungle-elementor' ),
		...
		$parent_options = [ '0' => __( 'Apenas nível superior', 'epicjungle-elementor' ) ] + $options;
		$this->add_control(
			'parent',
			[
				'label' => __( 'Pai', 'epicjungle-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
		...
		$this->add_control(
			'hide_empty',
			[
				'label' => __( 'Ocultar vazios', 'epicjungle-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Ocultar', 'epicjungle-elementor' ),
				'label_off' => __( 'Mostrar', 'epicjungle-elementor' ),
			]
		);
		...
		$this->add_control(
			'orderby',
			[
				'label' => __( 'Ordenar por', 'epicjungle-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'name',
				'options' => [
					'name' => __( 'Nome', 'epicjungle-elementor' ),
					'slug' => __( 'Slug', 'epicjungle-elementor' ),
					'description' => __( 'Descrição', 'epicjungle-elementor' ),
					'count' => __( 'Contagem', 'epicjungle-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'order',
			[
				'label' => __( 'Ordenar', 'epicjungle-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'desc',
				'options' => [
					'asc' => __( 'ASC', 'epicjungle-elementor' ),
					'desc' => __( 'DESC', 'epicjungle-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'heading_count_style',
			[
				'label'     => __( 'Contagem', 'epicjungle-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
