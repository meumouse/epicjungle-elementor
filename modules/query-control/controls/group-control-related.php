...
class Group_Control_Related extends Group_Control_Query {
	...
	protected function init_fields_by_name( $name ) {
		...
		$fields['post_type']['options']['related'] = __( 'Relacionado', 'epicjungle-elementor' );
		...
		$related_taxonomies = [
			'label' => __( 'Termo', 'epicjungle-elementor' ),
		...
		$related_fallback = [
			'label' => __( 'Fallback', 'epicjungle-elementor' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'fallback_none' => __( 'Nenhum', 'epicjungle-elementor' ),
				'fallback_by_id' => __( 'Seleção manual', 'epicjungle-elementor' ),
				'fallback_recent' => __( 'Postagens recentes', 'epicjungle-elementor' ),
			],
			'default' => 'fallback_none',
			'description' => __( 'Exibido se nenhum resultado relevante for encontrado. A ordem de exibição da seleção manual é aleatóriam', 'epicjungle-elementor' ),
			'condition' => [
				'post_type' => 'related',
			],
			'separator' => 'before',
