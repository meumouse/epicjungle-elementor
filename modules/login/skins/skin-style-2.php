...
class Skin_Style_2 extends Skin_Base {
	...
	public function get_id() {
        return 'login-style-2';
    }

    public function get_title() {
        return esc_html__( 'Entrar - Ilustração', 'epicjungle-elementor' );
    }
    ...
    public function render() {
        ...
        <section class="container d-flex justify-content-center align-items-center pt-7 pb-4" style="flex: 1 0 auto;">
            <div class="cs-signin-form mt-3 mx-auto bg-size-cover" <?php if ( $settings['show_background_image'] === 'yes' && ! empty ( $settings['bg_image']['url'] ) ):?> style="bottom:0; left:0;background-image: url(<?php echo esc_url( $settings["bg_image"]["url"] )?> );"<?php endif; ?>>
    ...
    protected function render_lost_password_form_link( $settings ) {
        $widget   = $this->parent;
    ...
    protected function render_register_form_link( $settings ) {
        $widget   = $this->parent;
    ...
    protected function render_login_form_link( $settings ) {
        $widget   = $this->parent;
    ...
    protected function render_rp_login_form_link( $settings ) {
        $widget   = $this->parent;
    ...
    protected function render_login_form( $settings ) {
        $widget   = $this->parent;
                ...
                <div <?php echo $widget->get_render_attribute_string( 'password-field-group' ); ?>>
                    ...
                    <div class="input-group">
                        ...
                        <label class="cs-password-toggle-btn">
                            <input class="custom-control-input" type="checkbox"><i class="fe-eye cs-password-toggle-indicator"></i><span class="sr-only"><?php echo esc_html__('Show password', 'epicjungle-elementor');?></span>
                        </label>
                    </div>
                </div>
    ...
    protected function render_register_form( $settings ) {
        $widget   = $this->parent;
    ...
    protected function render_password_reset_form( $settings ) {
        $widget   = $this->parent;
