...
class Skin_Topbar_Left_Nav extends Skin_Base {
    ...
    public function get_id() {
        return 'topbar_left_nav';
    }

    public function get_title() {
        return esc_html__( 'Navegação à esquerda da barra superior', 'epicjungle-elementor' );
    }
    ...
    public function render() {
        ...
        $icon_class = [
            'font-size-base text-muted mr-1',
            $settings['icon_class'],
        ];
        ...
        $args = [
            'echo'          => false,
            'menu'          => $settings['menu'],
            'menu_class'    => 'ej-elementor-nav-menu list-unstyled d-none d-md-flex flex-wrap text-nowrap mr-3 p-0 mb-0 ',
            'item_class'    => 'd-flex  ',
