...
class Skin_Navbar_Tool extends Skin_Base {
    ...
    public function get_title() {
        return esc_html__( 'Ferramenta de barra de navegação', 'epicjungle-elementor' );
    }
    ...
    public function render() {
        ...
        $args = [
            'echo'          => false,
            'menu'          => $settings['menu'],
            'menu_class'    => 'ej-elementor-nav-menu d-flex align-items-center ml-lg-auto ',
