<?php
namespace EpicJungleElementor\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'epicjungle_elementor/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'epicjungle_elementor/editor/localize_settings', [ $this, 'add_localize_data' ] );
