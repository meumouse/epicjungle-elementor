<?php
namespace SkolaElementor\Modules\ImageGallery\Skins;
...
use SkolaElementor\Plugin;
use SkolaElementor\Core\Utils as SK_Utils;

class Skin_Grid_Gallery extends Skin_Base  {
    ...
    public function get_id() {
        return 'sk-grid-gallery';
    }

    public function get_title() {
        return esc_html__( 'Grid Gallery', 'around-elementor' );
    }
    ...
    public function add_aroundgallery_data_to_image( $link_html, $id ) {
        $widget   = $this->parent;
    ...
    public function render() {
        ...
        add_filter( 'wp_get_attachment_link', [ $this, 'add_aroundgallery_data_to_image' ], 10, 2 );


        echo cs_gallery_shortcode( $args );


        remove_filter( 'wp_get_attachment_link', [ $this, 'add_aroundgallery_data_to_image' ] ); ?>
