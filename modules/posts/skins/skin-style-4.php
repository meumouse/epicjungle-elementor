    ...
    */
    public function render_portfolio_post() { 
     ...
     $terms  = get_the_terms( get_the_ID(), 'jetpack-portfolio-tag' );
        ...
        $cover_url = $this->epicjungle_get_the_post_cover_url();
     ...
     *
     */
        protected function epicjungle_get_the_post_cover_url( $post = null, $size = 'full' ) {
            $post_cover_id = $this->epicjungle_get_post_cover_id( $post );
         ...
         *
         */
        protected function epicjungle_get_post_cover_id( $post = null ) {
            $post = get_post( $post );
            ...
            $meta_data = get_post_meta( $post->ID, '_ej_cover_image', true );
