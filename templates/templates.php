...
namespace EpicJungleElementor\Templates;
    ...
    class Premium_Templates {
        ...
        */
        private function load_files() {
            ...
            require EPICJUNGLE_ELEMENTOR_TEMPLATES_PATH . 'classes/config.php';
            
            require EPICJUNGLE_ELEMENTOR_TEMPLATES_PATH . 'classes/assets.php';
            
            require EPICJUNGLE_ELEMENTOR_TEMPLATES_PATH . 'classes/manager.php';

            require EPICJUNGLE_ELEMENTOR_TEMPLATES_PATH . 'types/manager.php';

            require EPICJUNGLE_ELEMENTOR_TEMPLATES_PATH . 'classes/api.php';
